...
public class Long16Radix {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "l = 0x7fffffffffffffffL;byte[] bytes = longToBytes(l);long res = bytesToLong(bytes);的结果" + res);
        ...
        System.out.println(
                "Long.toBinaryString(maxLong>>1)低位溢出，符号位不变，并用符号位补溢出的高位:" + Long.toBinaryString(maxLong >> 1));
        System.out.println("Long.toHexString(maxLong>>>1):" + Long.toHexString(maxLong >>> 1));
        ...
        System.out.println(
                "Long.toBinaryString(minLong>>1)低位溢出，符号位不变，并用符号位补溢出的高位:" + Long.toBinaryString(minLong >> 1));
        System.out.println("Long.toHexString(minLong>>>1)" + Long.toHexString(minLong >>> 1));
