...
class BasicBitTest {
	...
	@Test
	void testIsOdd() {
		assertThat((2 & 1) == 0).isEqualTo(true);
		assertThat((2 % 2) == 0).isEqualTo(true);
		assertThat((13 & 1) == 0).isEqualTo(false);
		assertThat((13 % 2) == 0).isEqualTo(false);
	}
	...
	@Test
	void testReverse() {
		assertThat(~15 + 1).isEqualTo(-15);
	}

	@Test
	void testFindRightMost1Bit() {
		int x = 10;
	...
	public void testAbs() {
		...
		//>>>逻辑右移：低位溢出，高位补0
		assertThat((a >> 31) == 0 ? a : ~a + 1).isEqualTo(5);

		// 优化版本
		assertThat((a ^ (a >> 31)) - (a >> 31)).isEqualTo(5);
	}
	...
	@Test
	void findNearestPowerOf2() {
		assertThat(largestPower(62L)).isEqualTo(32L);
		assertThat(largestPower(129)).isEqualTo(128L);
		assertThat(Integer.highestOneBit(129)).isEqualTo(128);
		assertThat(Integer.highestOneBit(255)).isEqualTo(128);
		assertThat(Integer.highestOneBit(256)).isEqualTo(256);
		assertThat(Integer.highestOneBit(257)).isEqualTo(256);
	}

	/**
	 * {@link Integer#highestOneBit(int)}思想一样
	 */
	private long largestPower(long n) {
