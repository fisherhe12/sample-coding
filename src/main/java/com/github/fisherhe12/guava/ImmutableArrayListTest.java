...
class ImmutableArrayListTest {
	...
	void createByJdk() {
		...
		Assertions.assertThrows(UnsupportedOperationException.class, this::createByJdk, "bad");
	}
	...
	@Test
	void transform() {
		List<String> transformedList = Lists
				.transform(peopleList, personDTO -> personDTO != null ? personDTO.getName() : "");
