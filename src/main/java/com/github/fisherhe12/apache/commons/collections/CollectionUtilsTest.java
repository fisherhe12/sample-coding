...
public class CollectionUtilsTest {
    ...
    @Test
    public void matches() {
        System.out.println(IterableUtils.matchesAny(playerList, player -> player.getName().length() > 7 && player
            .getNumber() > 30));
        System.out.println(IterableUtils.matchesAll(playerList, player -> player.getName().length() > 7 && player
            .getNumber() > 30));
